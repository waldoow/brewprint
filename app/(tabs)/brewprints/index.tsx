    ...
    switch (activeTab) {
      ...
      case "archived":
        return {
          ...
          description: "Outdated or discontinued recipes will appear here for reference",
        };
      default:
        return {
          title: "No Brewing Recipes",
          description: "Import or create your first brewing recipe to start optimizing extraction parameters",
        };
    }
  };
  ...
  return (
    <ThemedView noBackground={false} style={styles.container}>
      <Header
        ...
        subtitle={`${filteredBrewprints.length} recipe${filteredBrewprints.length === 1 ? '' : 's'} • ${activeTab.charAt(0).toUpperCase() + activeTab.slice(1)}`}
      ...
      <ThemedView style={styles.actionContainer}>
        ...
        <ThemedButton size="sm" onPress={handleNewBrewprint} style={styles.newButton}>
          + New Recipe
        </ThemedButton>
      </ThemedView>
